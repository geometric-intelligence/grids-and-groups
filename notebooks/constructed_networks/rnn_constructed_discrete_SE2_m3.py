...
n_orientations = 3  # Number of discrete headings; this notebook uses C_m.
...
custom_orientation_weights = (1.0, 0.7, 0.4)  # One weight per discrete heading.
...
tuning_num_trajectories = 500  # Independent trajectories pooled for tuning estimates.
tuning_steps_per_trajectory = 160  # Samples generated in each trajectory.
tuning_burn_in_steps = 10  # Initial recurrent states discarded from each trajectory.
tuning_seed = 101  # Seed controlling trajectory seeds and starting positions.
tuning_min_occupancy = 5  # Mask conditional means based on fewer visits than this.
