"""
Tests for trained_networks/run_sweep.py
...
Usage:
    pytest trained_networks/tests/test_run_sweep.py -v
"""
...
from trained_networks.run_sweep import (
    deep_merge_dict,
...
def _run_sweep_and_check(sweep_config_path, mock_all_plots, expected_experiments):
    ...
    from trained_networks.run_sweep import run_parameter_sweep
    ...
    with tempfile.TemporaryDirectory() as tmpdir:
        ...
        # uses relative paths like "trained_networks/configs/config.yaml" resolved from repo root.
